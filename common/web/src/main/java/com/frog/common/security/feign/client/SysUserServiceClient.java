package com.frog.common.security.feign.client;

import com.frog.common.response.ApiResponse;
import com.frog.common.security.domain.SecurityUser;
import com.frog.common.security.feign.fallback.UserServiceClientFallback;
...
public interface SysUserServiceClient {
     ...
     * 更新最后登录信息
     */
    @GetMapping("/internal/{userId}/update-login")
